...
from app.sports.nfl.schemas import PickResponse, PickCreate, PickUpdate
from app.sports.nfl.services import PickService
...
async def get_pick(pick_id: UUID, db: AsyncSession = Depends(get_db)):
    """Get pick by ID"""
    pick_service = PickService(db)
